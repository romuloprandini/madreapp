...
namespace MadreApp.Pages
{
    ...
    public partial class Presentation3View : ContentView
    {
        public Presentation3View()
        {
            ...
            var image = new Image() { Source = "doctor2.png", Scale = .6 };
            var title = new Label()
            {
                Text = "Agendamentos",
            ...
            var text = new Label()
            {
                Text = "Agende sua consulta" + Environment.NewLine + "com no máximo 10 dias",
                FontFamily = "Droid Sans Mono",
                TextColor = Color.White,
